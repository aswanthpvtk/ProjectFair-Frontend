...
function EditProject({ project }) {
  ...
  return (
    <>
      <i class="fa-regular fa-pen-to-square text-info" onClick={handleShow}></i>
        ...
        <Modal.Body>
          <div className='row'>
            ...
            <div className='col-md-6'>
              ...
              />
              <input type="text" value={projectDetails.language} placeholder='Language used' className='form-control mb-3'
              ...
              />
              <textarea name="" value={projectDetails.overview} placeholder='Project Overview' rows={4} className='form-control mb-3'
